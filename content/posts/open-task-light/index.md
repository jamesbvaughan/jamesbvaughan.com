---
title: Building the Open Task Light
date: 2026-08-31
sharing: false
---
...
I've enjoyed following the project since the beginning.
...
![My completed Open Task Light](otl-wide.jpg)
...
- use an LED of similarly high quality (high CRI) and high output power to the Dyson lamp
...
![All the parts included my beta build kit](otl-kit-parts.jpg)
...
![A bunch of printed prints that didn't quite work](otl-parts.jpg)
...
perfectly snug fig for one tester could be an impossible fit for a different tester.

![Verifying the printed width of some walls](otl-calipers.jpg)

## Thoughts on the lamp itself

I love this thing.
I had been wanting a task light that was easy to position, dimmable, used a high
CRI LED.
...
would be great to be able to bright the lamp along without needing to move the
power supply.

## More photos of my build

![Another full view of my lamp](otl-tall.jpg)

![Close-up shot of the carriage](otl-carriage.jpg)
...
Here you can see the heat pipe that's integrated in to the horizontal rail,
